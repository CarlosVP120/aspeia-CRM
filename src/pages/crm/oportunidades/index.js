...
import ServerSideToolbar from 'src/views/table/data-grid/ServerSideToolbarOportunidades'
...
// ** Columns Import
import { getColumns } from 'src/constants/OportunidadesCols'

const ENTITY = 'oportunidad'
...
const Oportunidades = () => {
  ...
  const fetchEntityDefs = async () => {
    await axios
      ...
      .then(res => {
        console.log('oportunidad Defs', res.data.data)
  ...
  useEffect(() => {
    const channel = supabase
      ...
      .on('postgres_changes', { event: '*', schema: 'public', table: 'oportunidad' }, payload => {
